...
class FireDamageGraph:
    ...
    def __new__(cls):
        if cls.INSTANCE is None:
            ...
            cls.INSTANCE.graph = None  # Initialize graph as None
            cls.INSTANCE.df = None     # Store DataFrame reference
            cls.INSTANCE.get_graph()   # Load or build the graph
        return cls.INSTANCE
    ...
    def get_graph(self):
        ...
        if os.path.exists(self.CACHE_FILE):
            ...
            self.graph = nx.read_gpickle(self.CACHE_FILE)
        else:
    ...
    def build_graph(self):
        ...
        try:
            ...
            distance_threshold = 500 / 111000  # meters to degrees approximation
